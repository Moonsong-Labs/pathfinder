...
use pathfinder_common::{
    ...
    SequencerAddress, SierraHash, StarknetVersion, StateCommitment, StateDiffCommitment,
    StorageAddress, StorageCommitment, StorageValue, TransactionCommitment, TransactionHash,
